...
mutable struct LeafCausalH # honest
    ...
    label        :: Union{Nothing, Union{Float64, Vector{Float64}}} # mean causal effect in leaf for Breiman like approach
end

mutable struct LeafCausalNH # nothonest
    inds_build   :: Vector{Int} # indices in the leaf
    label        :: Union{Nothing, Union{Float64, Vector{Float64}}} # mean causal effect in leaf
end

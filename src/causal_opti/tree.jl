    ...
    function _split!(
        ...
        for feature in random_features
            ...
            while hi < n_samples
                ...
                if lo-1 >= min_samples_leaf && n_samples - (lo-1) >= min_samples_leaf && l_w_sum >= min_samples_leaf && lo-1-l_w_sum >= min_samples_leaf && r_w_sum >= min_samples_leaf && n_samples - (lo-1)-r_w_sum >= min_samples_leaf
